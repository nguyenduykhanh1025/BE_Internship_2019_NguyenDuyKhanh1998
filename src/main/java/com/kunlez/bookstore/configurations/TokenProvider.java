...
import static com.kunlez.bookstore.common.ConstantsCommon.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.kunlez.bookstore.common.ConstantsCommon.AUTHORITIES_KEY;
...
public class TokenProvider{
    ...
    public String generateToken(RegisterDTO registerDTO){
        return Jwts.builder()
                .setSubject(registerDTO.getEmail())
